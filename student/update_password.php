...
if(isset($_POST['save']))
{
	...
	$que=mysqli_query($conn,"select password from student_list where email='".$_SESSION['email']."'");
	...
	{
		mysqli_query($conn,"update student_list set password='$cp' where email='".$_SESSION['email']."'");
