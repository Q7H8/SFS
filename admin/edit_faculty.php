<?php
	...
	mysqli_query($conn,"update faculty_list set school_id='$school_id',firstname='$fname',lastname='$lname',email='$email',password='$pass',image='$image' where id='".$_GET['id']."'");	

    $err="<font color='green'>Faculty Details updated</font>";

	}

$con=mysqli_query($conn,"select * from faculty_list where id='".$_GET['id']."'");
